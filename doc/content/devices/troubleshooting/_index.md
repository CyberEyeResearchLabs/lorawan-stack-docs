...
- Check gateway and device events for traffic from your device. Below are a few common issues
    ...
    - **DevNonce has already been used** error in the device events: It indicates a duplicate use of Devnonce. It generally happens when the device had sent too many unsuccessful Join Requests
